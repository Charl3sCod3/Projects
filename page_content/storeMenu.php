...
if ($position == 3) {
 ...
 ?>
      ...
      <div class="card card-widget widget-user" style="" id="desktopView">
              ...
              <div id="companyLogoStore" class="widget-user-image">
                  <?php 
                  if(isset($userid)){
                  if ($userid == $cu_id) { ?>
        ...
        <div id="phoneView" style="height: 250px;background-image:url('images/<?php echo $stabbanner ?>');background-size: cover;background-repeat: no-repeat;position: relative;">
          <div style="width: 100px;height: 100px; overflow: hidden;border-radius: 50%;">
            <img style="width: 100%;height: 100%;" src="images/<?php echo $stablogo ?>">
          </div>
          <h4 style="margin: 0px;position: absolute;bottom: 10px;width: 100%;left: 0px;text-align: center;z-index: 8;padding: 5px;background-color: #00000087;color:white;font-weight: 800;"><?php echo $sdrow['companyName'] ?></h4>
        </div>
        <div class="row">
          <div class="col-12">
            <div class="card">
                ...
                <?php 
                 ...
                 ?>
                  ...
                  <div class="col-md-6">
                        ...
                        <?php if ($bcats == 4): ?>
                          <?php 
                                $percentaddition = (5 / 100) * $drow['food_price'];
                                $price = $drow['food_price'] + $percentaddition;
                                $getfoodrating = getfoodrating($drow[0]);
                           ?>
                 
                                  <div class="card" style="cursor: pointer;" id="product_containerD">
                                    <?php if (isset($userid)): ?>
                                                <?php
                                                $cv="SELECT * FROM `food_rating` WHERE `u_id`='$user_id' AND `f_id`='$drow[0]'";
                                                $cvq = $con->query($cv);
                                                $cvnr = $cvq->num_rows;
                                                if ($user_id != $cu_id AND $position == 4 AND $cvnr < 1) { ?>
                                                  <div style="display: flex;">
                                                    <?php 
                                                          echo "<small>Rating:</small>";
                                                          if ($getfoodrating >= 1 && $getfoodrating < 2) {
                                                              echo '<i class="fa fa-star" style="color:orange;float:right;"></i>';
                                                               echo '<i class="fa fa-star" style="color:lightgray;float:right;"></i>';
                                                               echo '<i class="fa fa-star" style="color:lightgray;float:right;"></i>';
                                                               echo '<i class="fa fa-star" style="color:lightgray;float:right;"></i>';
                                                               echo '<i class="fa fa-star" style="color:lightgray;float:right;"></i>';
                                                          }elseif ($getfoodrating >=2 && $getfoodrating < 3) {
                                                              echo '<i class="fa fa-star" style="color:orange;float:right;"></i>';
                                                               echo '<i class="fa fa-star" style="color:orange;float:right;"></i>';
                                                               echo '<i class="fa fa-star" style="color:lightgray;float:right;"></i>';
                                                               echo '<i class="fa fa-star" style="color:lightgray;float:right;"></i>';
                                                               echo '<i class="fa fa-star" style="color:lightgray;float:right;"></i>';
                                                          }elseif ($getfoodrating >=3 && $getfoodrating < 4) {
                                                             echo '<i class="fa fa-star" style="color:orange;float:right;"></i>';
                                                               echo '<i class="fa fa-star" style="color:orange;float:right;"></i>';
                                                               echo '<i class="fa fa-star" style="color:orange;float:right;"></i>';
                                                               echo '<i class="fa fa-star" style="color:lightgray;float:right;"></i>';
                                                               echo '<i class="fa fa-star" style="color:lightgray;float:right;"></i>';
                                                          }elseif ($getfoodrating >=4 && $getfoodrating < 5) {
                                                            echo '<i class="fa fa-star" style="color:orange;float:right;"></i>';
                                                               echo '<i class="fa fa-star" style="color:orange;float:right;"></i>';
                                                               echo '<i class="fa fa-star" style="color:orange;float:right;"></i>';
                                                               echo '<i class="fa fa-star" style="color:orange;float:right;"></i>';
                                                               echo '<i class="fa fa-star" style="color:lightgray;float:right;"></i>';
                                                          }elseif ($getfoodrating >= 5) {
                                                             echo '<i class="fa fa-star" style="color:orange;float:right;"></i>';
                                                               echo '<i class="fa fa-star" style="color:orange;float:right;"></i>';
                                                               echo '<i class="fa fa-star" style="color:orange;float:right;"></i>';
                                                               echo '<i class="fa fa-star" style="color:orange;float:right;"></i>';
                                                        ...
                                                        <div class="ratess" style="padding: 0px;margin:0px !important;">
                                                        <input onclick="rateFood(this.value,'<?php echo $drow[0] ?>','<?php echo $user_id ?>')" type="radio" id="star5" name="rate" value="5" />
                                                        <label for="star5" title="text">5 stars</label>
                                                        <input onclick="rateFood(this.value,'<?php echo $drow[0] ?>','<?php echo $user_id ?>')" type="radio" id="star4" name="rate" value="4" />
                                                        <label for="star4" title="text">4 stars</label>
                                                        <input onclick="rateFood(this.value,'<?php echo $drow[0] ?>','<?php echo $user_id ?>')" type="radio" id="star3" name="rate" value="3" />
                                                        <label for="star3" title="text">3 stars</label>
                                                        <input onclick="rateFood(this.value,'<?php echo $drow[0] ?>','<?php echo $user_id ?>')" type="radio" id="star2" name="rate" value="2" />
                                                        <label for="star2" title="text">2 stars</label>
                                                        <input onclick="rateFood(this.value,'<?php echo $drow[0] ?>','<?php echo $user_id ?>')" type="radio" id="star1" name="rate" value="1" />

...
<div class="card">
	...
	<div class="card-body">
		<div class="row">
			<?php 
				 				$o ="SELECT * FROM `orderdetails` WHERE `d_id`='$rrid' AND `delivery_status` between 1 and 2  GROUP BY `order_id` ASC";
				 				$oquery = $con->query($o);
				 				...
				 				while ($or = $oquery->fetch_array()) {
				 				 ...
				 				 <div class="col-md-6">
				 				 	<div class="card">
				 				 		...
				 				 		<a class="btn btn-danger btn-md float-right" href="includes/queries.php?orderCanceled=true&order_id=<?php echo $oorid ?>">Cancel</a>
				 				 		<a id="delbutton" href="includes/queries.php?delivered=true&order_id=<?php echo $oorid ?>" class="btn btn-success btn-md float-right" style=" margin-right: 1em;"><i class="fa fa-truck"></i> Delivered!</a>
				 				 	</div>
				 				 	</div>
				 				 </div>
				 				<?php } } ?>

      		...
      		<div class="card-body">
      			<div class="row">
      				<div class="col-md-6">
	                  	...
	                  	<div class="form-group">
		                    <label class="col-form-label" for="up">ACCOUNT CATEGORY:</label>
		                    <select name="up" required class="form-control" id="up" onchange="checkregistration()">
		                    	<option selected="" disabled="true">SELECT POSITION</option>
		                    	<?php 
		                    	$sql = "SELECT * FROM `account_category` WHERE ((`cat_id`=3) OR (`cat_id`=6))";
								$query = $con->query($sql);
